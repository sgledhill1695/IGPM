export default function GetInvolved(){
    ...
    return(
        <>
            <h3 className="text-[1.56rem] text-[#484848] mb-5 mt-[35px] sm:mt-[60px] lg:mt-[100px]">Would you like to apply to be a representative?</h3>

            <p className="mt-5">Download our ‘Representative – Role Purpose and Person Specification’ below.</p>
            ...
            <div className="bg-[url('/images/download-image.png')] bg-center bg-cover bg-no-repeat rounded-[25px] min-h-[190px] w-[100%] mt-10 relative">
                ...
                <div className="bg-[#1c4e7098] w-[100%] h-[100%] absolute top-[0px] left-[0px] rounded-[25px] ps-[5px] pe-[5px] sm:ps-[40px] flex items-center justify-center sm:justify-start">
                    ...
                    <a href="https://dashboard.igpm.org.uk/wp-content/uploads/2023/11/The-Institute-of-General-Practice-Management-Regional_Group-Representative-%E2%80%93-Role-Purpose-Person-Specification-.pdf" target="_blank">
