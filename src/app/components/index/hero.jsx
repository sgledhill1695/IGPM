            ...
            <div className={`${styles.heroContainer} relative`}>
                ...
                <div className='max-w-[1440px] m-auto'>
                    ...
                    <div className={`${styles.heroContainerText} h-[400px] md:h-[572px] lg:h-[560px] flex flex-col justify-center`}>
                        ...
                        <div className='flex flex-col  ms-[3vw] me-[3vw] sm:ms-[5vw] sm:me-[5vw] lg:ms-[162px] lg:me-[162px]'>

                            <h1 className='text-white z-10 max-w-[176px] sm:max-w-[100%]'>Welcome to the <span className='text-[#83C5E9]'>IGPM</span></h1>
