            ...
            <div className="max-w-[1440px] m-auto">
                ...
                <div className="ms-[3vw] me-[3vw] sm:ms-[5vw] sm:me-[5vw] xl:ms-[162px] xl:me-[162px]">
                    ...
                    <div className="relative">
                        ...
                        <h2 className="text-[#484848] text-center sm:text-start">Our promise to you</h2>
    
                        <svg xmlns="http://www.w3.org/2000/svg" height="125px" className="fill-[#1C4F70] opacity-[20%] absolute top-[-52px]" viewBox="0 0 448 512"><path d="M0 216C0 149.7 53.7 96 120 96h8c17.7 0 32 14.3 32 32s-14.3 32-32 32h-8c-30.9 0-56 25.1-56 56v8h64c35.3 0 64 28.7 64 64v64c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V320 288 216zm256 0c0-66.3 53.7-120 120-120h8c17.7 0 32 14.3 32 32s-14.3 32-32 32h-8c-30.9 0-56 25.1-56 56v8h64c35.3 0 64 28.7 64 64v64c0 35.3-28.7 64-64 64H320c-35.3 0-64-28.7-64-64V320 288 216z" /></svg>

                    </div>

                    <p className="mt-[20px] lg:mt-[14px] text-[1.1rems] text-center sm:text-start">
