        ...
        <>
            <div className="grid grid-cols-1 lg:grid-cols-2  mt-[35px] sm:mt-[60px] lg:mt-[100px] gap-[19px] items-center">
                ...
                <div className="flex flex-col items-center">
                    ...
                    <a className="w-[100%] sm:max-w-[500px] lg:w-[100%]" href="https://www.paypal.com/webapps/hermes?token=32R33450PE0069346&useraction=commit&wpsFlowRedirectToXorouterSkipHermesStartTime=1697029841117&mfid=1697029840826_f7309533ee478"><button className="bg-[#1B4E70] hover:bg-[#72C6ED] hover:text-[black] w-[100%] sm:max-w-[500px] lg:w-[100%] py-[8px] rounded-[8px] mt-3 text-white">Buy Now</button></a>
